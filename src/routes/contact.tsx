...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Contact DHA Karachi Real Estate for property buying, selling, renting and viewing enquiries.",
      },
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
      ...
      <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground">
        Tell us what you are looking for and the agency can follow up. Replace the placeholder contact details below before launch.
      </p>
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_1.1fr]">
        ...
        <div className="rounded-xl border border-border bg-card p-6 sm:p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Demo form — connect a backend or form service before launch.</p>
