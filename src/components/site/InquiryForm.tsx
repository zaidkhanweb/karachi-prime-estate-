...
export function InquiryForm({ defaultProperty = "", withDate = false }: Props) {
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="mt-4 space-y-3">
      <div>
        <label className="label-xs" htmlFor="iq-name">
          Name *
        </label>
        <input
          id="iq-name"
      ...
      <div>
        <label className="label-xs" htmlFor="iq-phone">
          Phone *
        </label>
        <input
          id="iq-phone"
      ...
      <div>
        <label className="label-xs" htmlFor="iq-property">
          Property *
        </label>
        <input
          id="iq-property"
      ...
      {withDate && (
        <div>
          <label className="label-xs" htmlFor="iq-date">
      ...
      <div>
        <label className="label-xs" htmlFor="iq-message">
          Message *
        </label>
        <textarea
          id="iq-message"
      ...
      {validated && (
        <p className="rounded-lg border border-accent/40 bg-accent/10 p-3 text-xs text-foreground">
          Demo mode: your details look complete, but nothing has been sent. Message sending
          needs to be connected before launch — for now please use WhatsApp or call.
        </p>
      )}
      <p className="text-[11px] text-muted-foreground">
        Demo form — submissions are not delivered yet.
      </p>
    </form>
  );
}
