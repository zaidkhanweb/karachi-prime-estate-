    ...
    <footer className="mt-20 border-t border-border bg-primary text-primary-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-3">
        <div>
          ...
          <div className="mt-5 flex gap-3">
            <a
              ...
              className="grid size-11 place-items-center rounded-full border border-primary-foreground/20 hover:border-accent hover:text-accent"
            >
        ...
        <div>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <a href={waLink("Hello, I'd like to enquire about a property.")} className="btn-base btn-accent">
              WhatsApp Us
            </a>
            <a href={business.directionsUrl} className="btn-base border border-primary-foreground/25">
              Get Directions
            </a>
          </div>
        </div>
      ...
      <div className="border-t border-primary-foreground/15">
        <div className="mx-auto max-w-7xl px-4 py-5 text-xs text-primary-foreground/55 sm:px-6">
          Demo website. Listings, prices, team profiles and reviews shown are sample
          placeholders and are not verified, currently available properties.
        </div>
      </div>
    </footer>
  );
